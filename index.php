...
<div class="row">
    ...
    <div class="col-lg-3 mb-4">
        <div class="card bg-info text-white shadow">
            <div class="card-body">
            <a class="text-white "  href="department.php" >List  Department</a> 
            ...
            <!-- <div class="card" ><a href="customer.php">view<i class="fas fa-arrow-right fa-fw" style="margin-right: 0rem;"></i></a>
            </div> -->
        </div>
    </div>
    ...
    <div class="col-lg-3 mb-4">
        <div class="card bg-primary text-white shadow">
            <div class="card-body">
              <a class="text-white"  href="employee.php">List Employee</a>
                <div class=" text-white">
                    <?php 
           ...
           <!--  <div class="card"><a href="category.php">view <i class="fas fa-arrow-right fa-fw" style="margin-right: 0rem;"></i></a>
            </div> -->
        </div>
    </div>
     <!-- <div class="col-lg-3 mb-4">
        ...
        <div class="card bg-success text-white shadow">
            <div class="card-body">
            <a class="text-white"  href="leave.php">List Leave</a> 
               ...
               <div class="text-white">
                    ...
                    // $query="select id from leaves where active=1";
                    // $result=mysqli_query($con,$query);
                    // $row=mysqli_num_rows($result);
                    // echo $row;
                     ?>
...
$total_leave_query = "SELECT COUNT(id) AS total_leave FROM leaves ";
...
$pending_leave_query = "SELECT COUNT(id) AS pending_leave FROM leaves WHERE  status = 1";
...
$approved_leave_query = "SELECT COUNT(id) AS approved_leave FROM leaves WHERE  status = 0";
...
$rejected_leave_query = "SELECT COUNT(id) AS rejected_leave FROM leaves WHERE  status = 2";
...
<div class="col-lg-3 mb-4">
        <div class="card bg-dark text-white shadow">
            <div class="card-body">
                <a class="text-white" href="leave.php">Total Leave</a>
                <div class="text-white">
    ...
    <div class="col-lg-3 mb-4">
        <div class="card bg-warning text-white shadow">
            <div class="card-body">
                <a class="text-white" href="leave.php?status=pending">Pending Leave</a>
                <div class="text-white">
    ...
    <div class="col-lg-3 mb-4">
        <div class="card bg-success text-white shadow">
            <div class="card-body">
                <a class="text-white" href="leave.php?status=approved">Approved Leaves</a>
                <div class="text-white">
    ...
    <div class="col-lg-3 mb-4">
        <div class="card bg-danger text-white shadow">
            <div class="card-body">
                <a class="text-white" href="leave.php?status=rejected">Rejected Leaves</a>
                <div class="text-white">
